...
[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(EditorTemplateDemo.StructureMapConfig), "Configure")]
	...
	public static class StructureMapConfig
	{
		public static void Configure()
		{
			IoC.Container.Configure(cfg =>
			{
				...
				cfg.AddRegistry(new ActionFilterRegistry(namespacePrefix: "EditorTemplateDemo"));
